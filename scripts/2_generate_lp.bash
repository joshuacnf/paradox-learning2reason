...
do
   python sample/sample.py --vocab_file sample/vocab.txt --output_file $FOLDER/prop_examples_$number.txt --min_pred_num 5 --max_pred_num 30 --algo LP --example_num 1000 --balance_by_depth --max_depth 6 & 
done
